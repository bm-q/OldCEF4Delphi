...
type
  TOldPDFPrintOptions = class(TPersistent)
    protected
      Fpage_width            : integer;
      ...
      Fmargin_left           : double;
      Fmargin_type           : TOldCefPdfPrintMarginType;
    ...
    published
      ...
      property margin_type           : TOldCefPdfPrintMarginType  read Fmargin_type              write Fmargin_type           default PDF_PRINT_MARGIN_DEFAULT;
...
constructor TOldPDFPrintOptions.Create;
begin
  Fpage_width            := 0;
  Fpage_height           := 0;
  Fmargin_top            := 0;
