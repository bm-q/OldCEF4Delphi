...
uses
  ...
  {$ENDIF}
  oldCEFTypes, oldCEFInterfaces, oldCEFBase, oldCEFSchemeRegistrar;
...
type
  TOldCefApplication = class
    protected
      FCache                         : oldustring;
      FCookies                       : oldustring;
      FUserDataPath                  : oldustring;
      FUserAgent                     : oldustring;
      FProductVersion                : oldustring;
      FLocale                        : oldustring;
      FLocalesRequired               : oldustring;
      FLogFile                       : oldustring;
      FBrowserSubprocessPath         : oldustring;
      FCustomFlashPath               : oldustring;
      FLogSeverity                   : TOldCefLogSeverity;
      FJavaScriptFlags               : oldustring;
      FResourcesDirPath              : oldustring;
      FLocalesDirPath                : oldustring;
      ...
      FContextSafetyImplementation   : TOldCefContextSafetyImplementation;
      ...
      FAppSettings                   : TOldCefSettings;
      FDeviceScaleFactor             : single;
      FCheckDevToolsResources        : boolean;
      FStatus                        : TOldCefAplicationStatus;
      FMissingLibFiles               : string;
      FProcessType                   : TOldCefProcessType;
      ...
      procedure SetCache(const aValue : oldustring);
      procedure SetCookies(const aValue : oldustring);
      procedure SetUserDataPath(const aValue : oldustring);
      procedure SetBrowserSubprocessPath(const aValue : oldustring);
      procedure SetResourcesDirPath(const aValue : oldustring);
      procedure SetLocalesDirPath(const aValue : oldustring);
      ...
      function  ExecuteProcess(const aApp : IOldCefApp) : integer;
      procedure InitializeSettings(var aSettings : TOldCefSettings);
      function  InitializeLibrary(const aApp : IOldCefApp) : boolean;
      ...
      function  ParseProcessType : TOldCefProcessType;
    ...
    public
      ...
      // Internal procedures. Only TInternalApp, TOldCefCustomBrowserProcessHandler,
      // ICefResourceBundleHandler, ICefRenderProcessHandler and ICefLoadHandler should use them.
      procedure   Internal_OnBeforeCommandLineProcessing(const processType: oldustring; const commandLine: IOldCefCommandLine);
      procedure   Internal_OnRegisterCustomSchemes(const registrar: IOldCefSchemeRegistrar);
      procedure   Internal_OnContextInitialized;
      procedure   Internal_OnBeforeChildProcessLaunch(const commandLine: IOldCefCommandLine);
      procedure   Internal_OnRenderProcessThreadCreated(const extraInfo: IOldCefListValue);
      function    Internal_GetLocalizedString(stringId: Integer; var stringVal: oldustring) : boolean;
      function    Internal_GetDataResource(resourceId: Integer; var data: Pointer; var dataSize: NativeUInt) : boolean;
      function    Internal_GetDataResourceForScale(resourceId: Integer; scaleFactor: TOldCefScaleFactor; var data: Pointer; var dataSize: NativeUInt) : boolean;
      procedure   Internal_OnRenderThreadCreated(const extraInfo: IOldCefListValue);
      procedure   Internal_OnWebKitInitialized;
      procedure   Internal_OnBrowserCreated(const browser: IOldCefBrowser);
      procedure   Internal_OnBrowserDestroyed(const browser: IOldCefBrowser);
      procedure   Internal_OnBeforeNavigation(const browser: IOldCefBrowser; const frame: IOldCefFrame; const request: IOldCefRequest; navigationType: TOldCefNavigationType; isRedirect: Boolean; var aStopNavigation : boolean);
      procedure   Internal_OnContextCreated(const browser: IOldCefBrowser; const frame: IOldCefFrame; const context: IOldCefv8Context);
      procedure   Internal_OnContextReleased(const browser: IOldCefBrowser; const frame: IOldCefFrame; const context: IOldCefv8Context);
      procedure   Internal_OnUncaughtException(const browser: IOldCefBrowser; const frame: IOldCefFrame; const context: IOldCefv8Context; const exception: IOldCefV8Exception; const stackTrace: IOldCefV8StackTrace);
      procedure   Internal_OnFocusedNodeChanged(const browser: IOldCefBrowser; const frame: IOldCefFrame; const node: IOldCefDomNode);
      procedure   Internal_OnProcessMessageReceived(const browser: IOldCefBrowser; sourceProcess: TOldCefProcessId; const aMessage: IOldCefProcessMessage; var aHandled : boolean);
      procedure   Internal_OnLoadingStateChange(const browser: IOldCefBrowser; isLoading, canGoBack, canGoForward: Boolean);
      procedure   Internal_OnLoadStart(const browser: IOldCefBrowser; const frame: IOldCefFrame);
      procedure   Internal_OnLoadEnd(const browser: IOldCefBrowser; const frame: IOldCefFrame; httpStatusCode: Integer);
      procedure   Internal_OnLoadError(const browser: IOldCefBrowser; const frame: IOldCefFrame; errorCode: Integer; const errorText, failedUrl: oldustring);

      property Cache                             : oldustring                             read FCache                             write SetCache;
      property Cookies                           : oldustring                             read FCookies                           write SetCookies;
      property UserDataPath                      : oldustring                             read FUserDataPath                      write SetUserDataPath;
      property UserAgent                         : oldustring                             read FUserAgent                         write FUserAgent;
      property ProductVersion                    : oldustring                             read FProductVersion                    write FProductVersion;
      property Locale                            : oldustring                             read FLocale                            write FLocale;
      property LogFile                           : oldustring                             read FLogFile                           write FLogFile;
      property BrowserSubprocessPath             : oldustring                             read FBrowserSubprocessPath             write SetBrowserSubprocessPath;
      property LogSeverity                       : TOldCefLogSeverity                     read FLogSeverity                       write FLogSeverity;
      property JavaScriptFlags                   : oldustring                             read FJavaScriptFlags                   write FJavaScriptFlags;
      property ResourcesDirPath                  : oldustring                             read FResourcesDirPath                  write SetResourcesDirPath;
      property LocalesDirPath                    : oldustring                             read FLocalesDirPath                    write SetLocalesDirPath;
      ...
      property ContextSafetyImplementation       : TOldCefContextSafetyImplementation     read FContextSafetyImplementation       write FContextSafetyImplementation;
      ...
      property BackgroundColor                   : TOldCefColor                           read FBackgroundColor                   write FBackgroundColor;
      ...
      property SmoothScrolling                   : TOldCefState                           read FSmoothScrolling                   write FSmoothScrolling;
      ...
      property LocalesRequired                   : oldustring                             read FLocalesRequired                   write FLocalesRequired;
      property CustomFlashPath                   : oldustring                             read FCustomFlashPath                   write FCustomFlashPath;
      property ProcessType                       : TOldCefProcessType                     read FProcessType;
      ...
      property Status                            : TOldCefAplicationStatus                read FStatus;
  ...
  TOldCefDirectoryDeleterThread = class(TThread)
    protected
      FDirectory : string;
...
var
  GlobalOldCEFApp : TOldCefApplication = nil;

procedure DestroyGlobalOldCEFApp;
...
uses
  ...
  oldCEFSchemeHandlerFactory, oldCEFCookieManager, oldCEFApp;

procedure DestroyGlobalOldCEFApp;
begin
  if (GlobalOldCEFApp <> nil) then FreeAndNil(GlobalOldCEFApp);
end;

constructor TOldCefApplication.Create;
begin
  inherited Create;
  ...
  FAppSettings.size := SizeOf(TOldCefSettings);
...
destructor TOldCefApplication.Destroy;
begin
  try
...
procedure TOldCefApplication.AfterConstruction;
begin
...
procedure TOldCefApplication.AddCustomCommandLine(const aCommandLine, aValue : string);
begin
...
function TOldCefApplication.MultiExeProcessing : boolean;
var
  TempApp : IOldCefApp;
begin
  Result  := False;
  ...
  try
    try
      if (ProcessType = ptBrowser) and
         ...
         LoadCEFlibrary then
        begin
          TempApp := TOldCustomCefApp.Create(self);
          Result  := InitializeLibrary(TempApp);
        end;
    except
      on e : exception do
        if CustomExceptionHandler('TOldCefApplication.MultiExeProcessing', e) then raise;
    end;
  finally
    TempApp := nil;
  end;
...
function TOldCefApplication.SingleExeProcessing : boolean;
var
  TempApp : IOldCefApp;
begin
  Result  := False;
...
function TOldCefApplication.GetLibCefVersion : string;
begin
...
function TOldCefApplication.GetLibCefPath : string;
begin
  Result := LIBCEF_DLL;
end;

procedure TOldCefApplication.SetCache(const aValue : oldustring);
begin
...
procedure TOldCefApplication.SetCookies(const aValue : oldustring);
begin
  if (length(aValue) > 0) then
    begin
      if CustomPathIsRelative(aValue) then
...
procedure TOldCefApplication.SetUserDataPath(const aValue : oldustring);
begin
  if (length(aValue) > 0) then
    begin
      if CustomPathIsRelative(aValue) then
...
procedure TOldCefApplication.SetBrowserSubprocessPath(const aValue : oldustring);
begin
  if (length(aValue) > 0) then
    begin
      if CustomPathIsRelative(aValue) then
...
procedure TOldCefApplication.SetResourcesDirPath(const aValue : oldustring);
var
  TempPath : string;
begin
  if (length(aValue) > 0) then
...
procedure TOldCefApplication.SetLocalesDirPath(const aValue : oldustring);
var
  TempPath : string;
begin
  if (length(aValue) > 0) then
...
function TOldCefApplication.StartMainProcess : boolean;
begin
...
function TOldCefApplication.StartSubProcess : boolean;
var
  TempApp : IOldCefApp;
begin
  Result  := False;
...
begin
  try
    ...
    on e : exception do
      if CustomExceptionHandler('TOldCefApplication.ShutDown', e) then raise;
  end;
end;

procedure TOldCefApplication.FreeLibcefLibrary;
begin
  try
    try
      ...
      on e : exception do
        if CustomExceptionHandler('TOldCefApplication.FreeLibcefLibrary', e) then raise;
    end;
  finally
    FLibHandle := 0;
    FLibLoaded := False;
...
function TOldCefApplication.ExecuteProcess(const aApp : IOldCefApp) : integer;
var
  TempArgs : TOldCefMainArgs;
begin
  Result := -1;
  try
    if (aApp <> nil) then
    ...
    on e : exception do
      begin
        ...
        if CustomExceptionHandler('TOldCefApplication.ExecuteProcess', e) then raise;
      end;
  end;
end;

procedure TOldCefApplication.InitializeSettings(var aSettings : TOldCefSettings);
begin
  aSettings.size                            := SizeOf(TOldCefSettings);
...
function TOldCefApplication.InitializeLibrary(const aApp : IOldCefApp) : boolean;
var
  TempArgs : TOldCefMainArgs;
begin
  Result := False;
  ...
  try
    try
      ...
      on e : exception do
        if CustomExceptionHandler('TOldCefApplication.InitializeLibrary', e) then raise;
    end;
  finally
...
function TOldCefApplication.InitializeCookies : boolean;
var
...
begin
  ...
  try
    if (length(FCookies) > 0) then
      begin
        TempCookieManager := TOldCefCookieManagerRef.Global(nil);

        if (TempCookieManager <> nil) and
           TempCookieManager.SetStoragePath(FCookies, FPersistSessionCookies, nil) then
          Result := True
         else
          OutputDebugMessage('TOldCefApplication.InitializeCookies error : cookies cannot be accessed');
      end
     else
      Result := True;
  except
    on e : exception do
      if CustomExceptionHandler('TOldCefApplication.InitializeCookies', e) then raise;
  end;
end;

procedure TOldCefApplication.RenameAndDeleteDir(const aDirectory : string);
var
  TempOldDir, TempNewDir : string;
  i : integer;
  TempThread : TOldCefDirectoryDeleterThread;
begin
  try
    ...
    if (Pos(PathDelim, TempOldDir) > 0) and
      ...
      begin
        ...
        if MoveFileW(PWideChar(TempOldDir + chr(0)), PWideChar(TempNewDir + chr(0))) then
          begin
            TempThread := TOldCefDirectoryDeleterThread.Create(TempNewDir);
            {$IFDEF DELPHI14_UP}
            TempThread.Start;
            {$ELSE}
            TempThread.Resume;
    ...
    on e : exception do
      if CustomExceptionHandler('TOldCefApplication.RenameAndDeleteDir', e) then raise;
  end;
end;

function TOldCefApplication.FindFlashDLL(var aFileName : string) : boolean;
var
...
begin
  ...
  try
    ...
    on e : exception do
      if CustomExceptionHandler('TOldCefApplication.FindFlashDLL', e) then raise;
  end;
end;

procedure TOldCefApplication.ShowErrorMessageDlg(const aError : string);
begin
...
function TOldCefApplication.ParseProcessType : TOldCefProcessType;
const
...
procedure TOldCefApplication.Internal_OnContextInitialized;
begin
  InitializeCookies;
...
procedure TOldCefApplication.Internal_OnBeforeChildProcessLaunch(const commandLine: IOldCefCommandLine);
begin
  if assigned(FOnBeforeChildProcessLaunch) then FOnBeforeChildProcessLaunch(commandLine);
end;

procedure TOldCefApplication.Internal_OnRenderProcessThreadCreated(const extraInfo: IOldCefListValue);
begin
  if assigned(FOnRenderProcessThreadCreated) then FOnRenderProcessThreadCreated(extraInfo);
end;

function TOldCefApplication.Internal_GetLocalizedString(stringid: Integer; var stringVal: oldustring) : boolean;
begin
  Result := False;
...
function TOldCefApplication.Internal_GetDataResource(resourceId: Integer; var data: Pointer; var dataSize: NativeUInt) : boolean;
begin
  Result := False;
...
function TOldCefApplication.Internal_GetDataResourceForScale(resourceId: Integer; scaleFactor: TOldCefScaleFactor; var data: Pointer; var dataSize: NativeUInt) : boolean;
begin
  Result := False;
...
procedure TOldCefApplication.Internal_OnRenderThreadCreated(const extraInfo: IOldCefListValue);
begin
  if assigned(FOnRenderThreadCreated) then FOnRenderThreadCreated(extraInfo);
end;

procedure TOldCefApplication.Internal_OnWebKitInitialized;
begin
  if assigned(FOnWebKitInitialized) then FOnWebKitInitialized;
end;

procedure TOldCefApplication.Internal_OnBrowserCreated(const browser: IOldCefBrowser);
begin
  if assigned(FOnBrowserCreated) then FOnBrowserCreated(browser);
end;

procedure TOldCefApplication.Internal_OnBrowserDestroyed(const browser: IOldCefBrowser);
begin
  if assigned(FOnBrowserDestroyed) then FOnBrowserDestroyed(browser);
end;

procedure TOldCefApplication.Internal_OnBeforeNavigation(const browser: IOldCefBrowser; const frame: IOldCefFrame; const request: IOldCefRequest; navigationType: TOldCefNavigationType; isRedirect: Boolean; var aStopNavigation : boolean);
begin
  if assigned(FOnBeforeNavigation) then FOnBeforeNavigation(browser, frame, request, navigationType, isRedirect, aStopNavigation);
end;

procedure TOldCefApplication.Internal_OnContextCreated(const browser: IOldCefBrowser; const frame: IOldCefFrame; const context: IOldCefv8Context);
begin
  if assigned(FOnContextCreated) then FOnContextCreated(browser, frame, context);
end;

procedure TOldCefApplication.Internal_OnContextReleased(const browser: IOldCefBrowser; const frame: IOldCefFrame; const context: IOldCefv8Context);
begin
  if assigned(FOnContextReleased) then FOnContextReleased(browser, frame, context);
end;

procedure TOldCefApplication.Internal_OnUncaughtException(const browser: IOldCefBrowser; const frame: IOldCefFrame; const context: IOldCefv8Context; const exception: IOldCefV8Exception; const stackTrace: IOldCefV8StackTrace);
begin
  if assigned(FOnUncaughtException) then FOnUncaughtException(browser, frame, context, exception, stackTrace);
end;

procedure TOldCefApplication.Internal_OnFocusedNodeChanged(const browser: IOldCefBrowser; const frame: IOldCefFrame; const node: IOldCefDomNode);
begin
  if assigned(FOnFocusedNodeChanged) then FOnFocusedNodeChanged(browser, frame, node);
end;

procedure TOldCefApplication.Internal_OnProcessMessageReceived(const browser: IOldCefBrowser; sourceProcess: TOldCefProcessId; const aMessage: IOldCefProcessMessage; var aHandled : boolean);
begin
...
procedure TOldCefApplication.Internal_OnLoadingStateChange(const browser: IOldCefBrowser; isLoading, canGoBack, canGoForward: Boolean);
begin
  if assigned(FOnLoadingStateChange) then FOnLoadingStateChange(browser, isLoading, canGoBack, canGoForward);
end;
 procedure TOldCefApplication.Internal_OnLoadStart(const browser: IOldCefBrowser; const frame: IOldCefFrame);
begin
  if assigned(FOnLoadStart) then FOnLoadStart(browser, frame);
end;
 procedure TOldCefApplication.Internal_OnLoadEnd(const browser: IOldCefBrowser; const frame: IOldCefFrame; httpStatusCode: Integer);
begin
  if assigned(FOnLoadEnd) then FOnLoadEnd(browser, frame, httpStatusCode);
end;
 procedure TOldCefApplication.Internal_OnLoadError(const browser: IOldCefBrowser; const frame: IOldCefFrame; errorCode: Integer; const errorText, failedUrl: oldustring);
begin
  if assigned(FOnLoadError) then FOnLoadError(browser, frame, errorCode, errorText, failedUrl);
end;

procedure TOldCefApplication.Internal_OnBeforeCommandLineProcessing(const processType : oldustring;
                                                                 const commandLine : IOldCefCommandLine);
var
  i : integer;
  TempVersionInfo : TOldFileVersionInfo;
  TempFileName : string;
...
procedure TOldCefApplication.Internal_OnRegisterCustomSchemes(const registrar: IOldCefSchemeRegistrar);
begin
  if assigned(FOnRegisterCustomSchemes) then FOnRegisterCustomSchemes(registrar);
end;

function TOldCefApplication.GetMustCreateResourceBundleHandler : boolean;
begin
...
function TOldCefApplication.GetMustCreateBrowserProcessHandler : boolean;
begin
  Result := FSingleProcess or
...
function TOldCefApplication.GetMustCreateRenderProcessHandler : boolean;
begin
  Result := FSingleProcess or
...
function TOldCefApplication.GetMustCreateLoadHandler : boolean;
begin
  Result := FSingleProcess or
            ((FProcessType = ptRenderer) and
...
function TOldCefApplication.GetGlobalContextInitialized : boolean;
begin
  Result := FGlobalContextInitialized or not(MustCreateBrowserProcessHandler);
end;

function TOldCefApplication.GetChildProcessesCount : integer;
{$IFDEF MSWINDOWS}
var
  TempHandle  : THandle;
...
function TOldCefApplication.GetUsedMemory : cardinal;
{$IFDEF MSWINDOWS}
var
  TempHandle   : THandle;
  TempProcess  : TProcessEntry32;
...
function TOldCefApplication.GetTotalSystemMemory : uint64;
{$IFDEF MSWINDOWS}
var
  TempMemStatus : TMyOldMemoryStatusEx;
{$ENDIF}
begin
  Result := 0;

  {$IFDEF MSWINDOWS}
  ZeroMemory(@TempMemStatus, SizeOf(TMyOldMemoryStatusEx));
  TempMemStatus.dwLength := SizeOf(TMyOldMemoryStatusEx);
  if GetGlobalMemoryStatusEx(TempMemStatus) then Result := TempMemStatus.ullTotalPhys;
  {$ENDIF}
end;

function TOldCefApplication.GetAvailableSystemMemory : uint64;
{$IFDEF MSWINDOWS}
var
  TempMemStatus : TMyOldMemoryStatusEx;
{$ENDIF}
...
function TOldCefApplication.GetSystemMemoryLoad : cardinal;
{$IFDEF MSWINDOWS}
var
  TempMemStatus : TMyOldMemoryStatusEx;
{$ENDIF}
...
function TOldCefApplication.LoadCEFlibrary : boolean;
var
...
begin
  ...
  if (FStatus <> asLoading) or FLibLoaded or (FLibHandle <> 0) then
    begin
      ...
      TempString := 'GlobalOldCEFApp can only be initialized once per process.';
...
function TOldCefApplication.Load_cef_app_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_browser_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_command_line_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_cookie_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_drag_data_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_geolocation_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_origin_whitelist_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_parser_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_path_util_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_print_settings_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_process_message_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_process_util_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_request_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_request_context_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_resource_bundle_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_response_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_scheme_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_stream_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_task_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_trace_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_urlrequest_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_v8_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_values_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_web_plugin_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_xml_reader_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_zip_reader_capi_h : boolean;
begin
...
function TOldCefApplication.Load_cef_logging_internal_h : boolean;
begin
...
function TOldCefApplication.Load_cef_string_list_h : boolean;
begin
...
function TOldCefApplication.Load_cef_string_map_h : boolean;
begin
...
function TOldCefApplication.Load_cef_string_multimap_h : boolean;
begin
...
function TOldCefApplication.Load_cef_string_types_h : boolean;
begin
...
function TOldCefApplication.Load_cef_thread_internal_h : boolean;
begin
...
function TOldCefApplication.Load_cef_trace_event_internal_h : boolean;
begin
...
// TOldCefDirectoryDeleterThread

constructor TOldCefDirectoryDeleterThread.Create(const aDirectory : string);
begin
...
procedure TOldCefDirectoryDeleterThread.Execute;
begin
  ...
  try
    ...
    on e : exception do
      if CustomExceptionHandler('TOldCefDirectoryDeleterThread.Execute', e) then raise;
  end;
end;
