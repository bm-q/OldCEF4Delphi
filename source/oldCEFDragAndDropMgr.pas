...
uses
  ...
  {$ENDIF}
  oldCEFDragData, oldCEFInterfaces, oldCEFTypes, oldOLEDragAndDrop;

type
  TOldDragEnterEvent = procedure(Sender: TObject; const aDragData : IOldCefDragData; grfKeyState: Longint; pt: TPoint; var dwEffect: Longint) of object;
  TOldDragOverEvent  = procedure(Sender: TObject; grfKeyState: Longint; pt: TPoint; var dwEffect: Longint) of object;
  TOldDropEvent      = procedure(Sender: TObject; grfKeyState: Longint; pt: TPoint; var dwEffect: Longint) of object;

  TOldCefDragAndDropMgr = class(TOLEDragAndDropMgr)
    protected
      FCurrentDragData    : IOldCefDragData;
      FOLEEffect          : integer;
      ...
      FOnDragEnter        : TOldDragEnterEvent;
      FOnDragOver         : TOldDragOverEvent;
      FOnDragLeave        : TNotifyEvent;
      FOnDrop             : TOldDropEvent;

      function  DragDataToDataObject_Unicode(const aDragData : IOldCefDragData; var aFormat : TFormatEtc; var aMedium : TStgMedium) : boolean;
      function  DragDataToDataObject_Text(const aDragData : IOldCefDragData; var aFormat : TFormatEtc;  var aMedium : TStgMedium) : boolean;
      function  DragDataToDataObject_HTML(const aDragData : IOldCefDragData; var aFormat : TFormatEtc; var aMedium : TStgMedium) : boolean;
      function  DragDataToDataObject_URL(const aDragData : IOldCefDragData; var aFormat : TFormatEtc; var aMedium : TStgMedium) : boolean;
      function  DragDataToDataObject_FileDesc(const aDragData : IOldCefDragData; var aFormat : TFormatEtc; var aMedium : TStgMedium) : boolean;
      function  DragDataToDataObject_FileContents(const aDragData : IOldCefDragData; var aFormat : TFormatEtc; var aMedium : TStgMedium) : boolean;

      procedure DataObjectToDragData(const aDataObject : IDataObject; var aDragData : IOldCefDragData);
      function  DataObjectToDragData_Unicode(var aMedium : TStgMedium; var aDragData : IOldCefDragData) : boolean;
      function  DataObjectToDragData_Text(var aMedium : TStgMedium; var aDragData : IOldCefDragData) : boolean;
      function  DataObjectToDragData_URL(var aMedium : TStgMedium; var aDragData : IOldCefDragData) : boolean;
      function  DataObjectToDragData_HTML(var aMedium : TStgMedium; var aDragData : IOldCefDragData) : boolean;
      function  DataObjectToDragData_FileDrop(var aMedium : TStgMedium; var aDragData : IOldCefDragData) : boolean;

      function  HtmlToCFHtml(var aHTML, aBaseURL : oldustring) : AnsiString;
    ...
    public
      ...
      function    StartDragging : TOldCefDragOperation;
      function    CloneDragData(const aDragData : IOldCefDragData; aAllowedOps : TOldCefDragOperations) : boolean;
      ...
      property    OnDragEnter        : TOldDragEnterEvent  read FOnDragEnter  write FOnDragEnter;
      property    OnDragOver         : TOldDragOverEvent   read FOnDragOver   write FOnDragOver;
      property    OnDragLeave        : TNotifyEvent     read FOnDragLeave  write FOnDragLeave;
      property    OnDrop             : TOldDropEvent       read FOnDrop       write FOnDrop;
  end;
...
uses
  oldCEFMiscFunctions, oldCEFWriteHandler, oldCEFStreamWriter, oldCEFConstants;

// *****************************************************
// **************** TOldCefDragAndDropMgr *****************
// *****************************************************

constructor TOldCefDragAndDropMgr.Create;
begin
  inherited Create;
...
destructor TOldCefDragAndDropMgr.Destroy;
begin
  FCurrentDragData := nil;
...
function TOldCefDragAndDropMgr.DragDataToDataObject_Unicode(const aDragData : IOldCefDragData;
...
function TOldCefDragAndDropMgr.DragDataToDataObject_Text(const aDragData : IOldCefDragData;
                                                      var   aFormat   : TFormatEtc;
                                                      var   aMedium   : TStgMedium) : boolean;
var
  TempText : AnsiString;
...
function TOldCefDragAndDropMgr.DragDataToDataObject_HTML(const aDragData : IOldCefDragData;
                                                      var   aFormat   : TFormatEtc;
                                                      var   aMedium   : TStgMedium) : boolean;
var
  TempBaseURL, TempHTML : oldustring;
  TempAnsi : AnsiString;
begin
  Result   := False;
...
function TOldCefDragAndDropMgr.DragDataToDataObject_URL(const aDragData : IOldCefDragData;
                                                     var   aFormat   : TFormatEtc;
                                                     var   aMedium   : TStgMedium) : boolean;
var
  TempURL, TempTitle : oldustring;
begin
  Result := False;
...
function TOldCefDragAndDropMgr.DragDataToDataObject_FileDesc(const aDragData : IOldCefDragData;
                                                          var   aFormat   : TFormatEtc;
                                                          var   aMedium   : TStgMedium) : boolean;
var
  TempFileName : oldustring;
  TempSize     : cardinal;
begin
  Result := False;
...
function TOldCefDragAndDropMgr.DragDataToDataObject_FileContents(const aDragData : IOldCefDragData;
                                                              var   aFormat   : TFormatEtc;
                                                              var   aMedium   : TStgMedium) : boolean;
var
  TempHandler   : IOldCefWriteHandler;
  TempWriter    : IOldCefStreamWriter;
  TempSize      : cardinal;
begin
  Result := False;
    ...
    begin
      ...
      if (TempSize > 0) then
        begin
          ...
          TempHandler := TOldCefBytesWriteHandler.Create(TempSize);
          TempWriter  := TOldCefStreamWriterRef.CreateForHandler(TempHandler);

          aDragData.GetFileContents(TempWriter);

          TempSize    := cardinal(TOldCefBytesWriteHandler(TempHandler).GetDataSize);
          Result      := GetStorageForBytes(aMedium, TOldCefBytesWriteHandler(TempHandler).GetData, TempSize);
        end;
    end;
end;

function TOldCefDragAndDropMgr.ZeroFiller(aNumber, aLength : integer) : AnsiString;
begin
...
function TOldCefDragAndDropMgr.HtmlToCFHtml(var aHTML, aBaseURL : oldustring) : AnsiString;
const
...
function TOldCefDragAndDropMgr.FindStringField(const aString, aFieldName : AnsiString; var aPos : integer) : string;
var
...
procedure TOldCefDragAndDropMgr.CFHtmlToHtml(const cf_html : AnsiString; var html, base_url : string);
const
...
function TOldCefDragAndDropMgr.DataObjectToDragData_Unicode(var aMedium : TStgMedium; var aDragData : IOldCefDragData) : boolean;
var
  TempText : string;
  TempPointer : pointer;
begin
...
function TOldCefDragAndDropMgr.DataObjectToDragData_Text(var aMedium : TStgMedium; var aDragData : IOldCefDragData) : boolean;
var
  TempText : string;
  TempPointer : pointer;
begin
...
function TOldCefDragAndDropMgr.DataObjectToDragData_URL(var aMedium : TStgMedium; var aDragData : IOldCefDragData) : boolean;
var
...
function TOldCefDragAndDropMgr.DataObjectToDragData_HTML(var aMedium : TStgMedium; var aDragData : IOldCefDragData) : boolean;
var
  TempAnsi : AnsiString;
...
function TOldCefDragAndDropMgr.DataObjectToDragData_FileDrop(var aMedium : TStgMedium; var aDragData : IOldCefDragData) : boolean;
var
  TempHdrop : HDROP;
...
procedure TOldCefDragAndDropMgr.DataObjectToDragData(const aDataObject : IDataObject; var aDragData : IOldCefDragData);
var
...
begin
  try
    aDragData := TOldCefDragDataRef.New;
    ...
    on e : exception do
      if CustomExceptionHandler('TOldCefDragAndDropMgr.DataObjectToDragData', e) then raise;
  end;
end;

function TOldCefDragAndDropMgr.StartDragging : TOldCefDragOperation;
var
...
function TOldCefDragAndDropMgr.CloneDragData(const aDragData : IOldCefDragData; aAllowedOps : TOldCefDragOperations) : boolean;
begin
...
function TOldCefDragAndDropMgr.DragEnter(const dataObj     : IDataObject;
                                            grfKeyState : Longint;
                                            pt          : TPoint;
                                      var   dwEffect    : Longint): HRESULT;
var
  TempDragData : IOldCefDragData;
begin
...
function TOldCefDragAndDropMgr.DragOver(grfKeyState: Longint; pt: TPoint; var dwEffect: Longint): HResult;
begin
...
function TOldCefDragAndDropMgr.DragLeave: HResult;
begin
...
function TOldCefDragAndDropMgr.Drop(const dataObj     : IDataObject;
                                       grfKeyState : Longint;
                                       pt          : TPoint;
                                 var   dwEffect    : Longint): HResult;
