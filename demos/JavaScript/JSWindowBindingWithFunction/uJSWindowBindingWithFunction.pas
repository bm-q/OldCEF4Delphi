...
begin
  ...
  TempFunction := TOldCefv8ValueRef.NewFunction('myfunc', TempHandler);
...
procedure TJSWindowBindingWithFunctionFrm.Chromium1AfterCreated(Sender: TObject; const browser: IOldCefBrowser);
begin
