...
var
  TempAccessor : IOldCefV8Accessor;
  TempObject   : IOldCefv8Value;
begin
  // This is the first JS Window Binding example in the "JavaScript Integration" wiki page at
  // https://bitbucket.org/chromiumembedded/cef/wiki/JavaScriptIntegration.md

  TempAccessor := TMyV8Accessor.Create;
  TempObject   := TOldCefv8ValueRef.NewObject(TempAccessor);
  TempObject.SetValueByKey('myval', TOldCefv8ValueRef.NewString('My Value!'), V8_PROPERTY_ATTRIBUTE_NONE);
...
procedure TJSWindowBindingWithObjectFrm.Chromium1AfterCreated(Sender: TObject; const browser: IOldCefBrowser);
begin
