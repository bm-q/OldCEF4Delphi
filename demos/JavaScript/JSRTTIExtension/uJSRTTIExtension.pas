...
uses
  uSimpleTextViewer, oldCEFv8Handler, uTestExtension, oldCEFMiscFunctions;
...
{$IFDEF DELPHI14_UP}
  ...
  // https://bitbucket.org/chromiumembedded/cef/wiki/JavaScriptIntegration.md
  TOldCefRTTIExtension.Register('myextension', TTestExtension);
{$ENDIF}
end;
...
procedure TJSRTTIExtensionFrm.Chromium1AfterCreated(Sender: TObject; const browser: IOldCefBrowser);
begin
